package com.aibees.service.maria.account.utils.constant;

public interface AccConstant {

    public static final String CARD_HANA = "HANACARD";
    ...
    public static final String ENTRY_IN = "0";
    public static final String ENTRY_OUT = "1";
